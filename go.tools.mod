module github.com/kubekanvas/karpenter-provider-stackit/tools
...
replace github.com/kubekanvas/karpenter-provider-stackit => ./

require (
	github.com/awslabs/operatorpkg v0.0.0-20260812232916-6d329cee9a40
	github.com/kubekanvas/karpenter-provider-stackit v0.0.0-00010101000000-000000000000
